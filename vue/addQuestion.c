...
int addQuestion(Window* window, FILE** filePointer) {
    ...
    SDL_Rect questionRect = {
        ...
        SCREEN_HEIGHT / 2 - PACKET_RECT_HEIGHT,
        QUESTION_RECT_WIDTH,
    ...
    Node* first = NULL;
    addTemplateToList(&first, window->renderer, 1, 1, 1, "", window->font);
    addButtonToList(&first, questionRect, color, empty(), NULL, 0, 0);
    ...
    while (!quit) {
        ...
        // if (textAdded){
            ...
            inputRect.y = questionRect.y * 2 - inputRect.h;
