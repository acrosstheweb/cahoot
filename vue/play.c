...
// int play(Window* window, char* packetName, QuestionData* questionData, int questionsNb) {
...
//     addButtonToList(&first, questionRect, red, questionTextRect, question, 0, 0); // Question
//     addButtonToList(&first, answer1Rect, red, answer1Rect, NULL, 1, 12); 
//     addButtonToList(&first, answer2Rect, green, answer2Rect, NULL, 1, 13);
//     addButtonToList(&first, answer3Rect, blue, answer3Rect, NULL, 1, 14);
//     addButtonToList(&first, answer4Rect, yellow, answer4Rect, NULL, 1, 15);
